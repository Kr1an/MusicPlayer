...
namespace TinySound.Application.Models.Storage
{
	public static class Storage
	{
		...
		public static void AddTestRecords()
		{
			...
			PlayLists[0].Audios.Add(1 ,new Audio() {FileHelper = new FileHelper() {FilePath = "rel1.mp3"}, AudioInfo = new AudioInfo() { Duration = 40, Genre = Genres.Asian,      Id = 1, Title = "Hot Summer" , Rating = 9} });
			PlayLists[0].Audios.Add(2, new Audio() {FileHelper = new FileHelper() {FilePath = "rel2.mp3"}, AudioInfo = new AudioInfo() { Duration = 40, Genre = Genres.AvantGarde, Id = 2, Title = "Yellow Moon", Rating = 9 } });
			PlayLists[0].Audios.Add(3, new Audio() {FileHelper = new FileHelper() {FilePath = "rel3.mp3"}, AudioInfo = new AudioInfo() { Duration = 54, Genre = Genres.Electronic, Id = 3, Title = "Hot Month"  , Rating = 9 } });

			PlayLists[1].Audios.Add(4, new Audio() {FileHelper = new FileHelper() {FilePath = "rel4.mp3"}, AudioInfo = new AudioInfo() { Duration = 80, Genre = Genres.Asian,      Id = 1, Title = "Hot Summer",  Rating = 4 } });
			PlayLists[1].Audios.Add(5, new Audio() {FileHelper = new FileHelper() {FilePath = "rel1.mp3"}, AudioInfo = new AudioInfo() { Duration = 80, Genre = Genres.AvantGarde, Id = 2, Title = "Yellow Moon", Rating = 8 } });
			PlayLists[1].Audios.Add(6, new Audio() {FileHelper = new FileHelper() {FilePath = "rel0.mp3"}, AudioInfo = new AudioInfo() { Duration = 40, Genre = Genres.Electronic, Id = 3, Title = "Hot Month",   Rating = 6 } });

			PlayLists[2].Audios.Add(7, new Audio() { FileHelper = new FileHelper() { FilePath = "relax_min.mp3" }, AudioInfo = new AudioInfo() { Duration = 40, Genre = Genres.Electronic, Id = 3, Title = "Hot Month", Rating = 6 } });
